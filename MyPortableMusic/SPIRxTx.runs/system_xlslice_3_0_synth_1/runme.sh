...
HD_PWD='D:/ZLab2021/lab14OLED/SPIRxTx.runs/system_xlslice_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_xlslice_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_xlslice_3_0.tcl
