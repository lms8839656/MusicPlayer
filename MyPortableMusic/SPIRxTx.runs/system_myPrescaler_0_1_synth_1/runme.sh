...
HD_PWD='D:/ZLab2021/lab14OLED/SPIRxTx.runs/system_myPrescaler_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_myPrescaler_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_myPrescaler_0_1.tcl
