...
HD_PWD='D:/ZLab2021/lab14OLED/SPIRxTx.runs/system_axi_fifo_mm_s_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_fifo_mm_s_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_fifo_mm_s_1_0.tcl
