...
HD_PWD='D:/ZLab2021/lab14OLED/SPIRxTx.runs/system_myI2SSlave_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_myI2SSlave_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_myI2SSlave_0_3.tcl
